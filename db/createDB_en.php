<?
	...
	$db->query("INSERT OR REPLACE INTO experience (_id, title, company, desc_short, desc, other, open, date_start, type) VALUES (
				...
				'HTML5 resume', 
				'', 
				'Designed a web resume using HTML5, Javascript and CSS transitions', 
	...
	$db->query("INSERT OR REPLACE INTO experience (_id, title, company, desc_short, desc, other, date_start, type) VALUES (
				...
				'', 
				'Developed the website of Polytech Nantes''s annual gala (<a href=\\\"http://polytechbynight.fr\\\">polytechbynight.fr</a>).', 
	...
	$db->query("INSERT OR REPLACE INTO experience (_id, title, company, desc_short, desc, other, image, open, date_start, type) VALUES (
				...
				'', 
				'Devised an HTML5 view for a chronological resume (<a href=\\\"http://cv.thomasbelin.fr/timeline/\\\">cv.thomasbelin.fr/timeline</a>)', 
	...
	$db->query("INSERT OR REPLACE INTO experience (_id, title, company, desc_short, desc, other, date_start, type) VALUES (
				...
				'Personal website', 
				'', 
				'Designed my personal website (<a href=\\\"http://thomasbelin.fr\\\">thomasbelin.fr</a>)', 
	...
	$db->query("INSERT OR REPLACE INTO experience (_id, title, company, desc_short, desc, other, date_start, type) VALUES (
				...
				'', 
				'Developed, with a partner, of a website for managing Polytech''s courses', 
				'This was a school project, with a partner, to develop a website for managing our school''s courses. As both of us already knew PHP quite well, we decided ... not to use it. So we used Python and Django to implement this website.', 
	...
	$db->query("INSERT OR REPLACE INTO experience (_id, title, company, desc_short, desc, other, date_start, type) VALUES (
				...
				'', 
				'An eight months project with a partner : development, using Javascript, of a workflow designer.',
	...
	$db->query("INSERT OR REPLACE INTO experience (_id, title, company, desc_short, desc, other, open, date_start, type) VALUES (
				...
				'', 
				'Designed an Open Source iPhone app for the french festival \\\"les Vieilles Charrues\\\" in 2010.', 
				'In 2010, the huge french festival \\\"Les Vieilles Charrrues\\\" (around 200 000 festival goers) wanted to have an iPhone application.  I only knew the basics of Objective C but I decided to develop this application. It is an Open Source project which can be found here : <a href=\\\"https://github.com/thomasbelin4/Vieilles-Charrues-iPhone\\\">https://github.com/thomasbelin4/Vieilles-Charrues-iPhone</a>', 
